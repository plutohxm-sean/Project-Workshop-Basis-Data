...
--
-- Host: localhost:3306
-- Generation Time: Jun 08, 2026 at 05:52 PM
...
(1, 1, 1, 'Nasi Ayam Geprek', 13000, 48),
(2, 1, 1, 'Geprek Mozzarella', 15000, 30),
...
--
-- Dumping data for table `menu_hapus`
--

INSERT INTO `menu_hapus` (`id_hapus`, `id_menu_lama`, `nama_menu`, `harga`, `stok_terakhir`, `tanggal_hapus`, `user_penghapus`) VALUES
(1, 21, 'Menu Dummy Untuk Trigger', 5000, 10, '2026-06-09 00:07:30', 'root@localhost');
...
INSERT INTO `pelanggan` (`id_pelanggan`, `nama_pelanggan`, `nim`, `jurusan`, `alamat`, `email`) VALUES
(1, 'Sean Antonio Tarigan', '2425600004', 'Telekomunikasi', 'Surabaya', NULL),
(2, 'Rizky Pratama', '3123600001', 'Telekomunikasi', 'Surabaya', NULL),
(3, 'Ahmad Fauzi', '3123600002', 'Teknik Informatika', 'Sidoarjo', NULL),
(4, 'Siti Aminah', '3123600003', 'Teknik Komputer', 'Gresik', NULL),
(5, 'Wahyu Hidayat', '3123600004', 'Teknik Elektro', 'Surabaya', NULL),
(6, 'Nisa Sabyan', '3123600005', 'Sistem Pembangkit Energi', 'Sidoarjo', NULL),
(7, 'Fajar Nugraha', '3123600006', 'Telekomunikasi', 'Mojokerto', NULL),
(8, 'Rina Nose', '3123600007', 'Teknik Mekatronika', 'Surabaya', NULL),
(9, 'Gilang Dirga', '3123600008', 'Teknologi Game', 'Gresik', NULL),
(10, 'Ayu Ting Ting', '3123600009', 'Sains Data', 'Surabaya', NULL);
...
(1, 1, 1, 5, 'Ayam gepreknya mantap, pedesnya pas!', '2026-06-06 00:46:11'),
(2, 13, 2, 4, 'Pangsitnya enak tapi kuahnya kurang panas.', '2026-06-06 00:46:11'),
(3, 17, 3, 5, 'Batagor terenak di PENS.', '2026-06-06 00:46:11'),
(4, 9, 4, 5, 'Coklatnya lumer banget, recommended!', '2026-06-06 00:46:11'),
(5, 5, 5, 4, 'Bumbu rempahnya kerasa, porsinya ngenyangin.', '2026-06-06 00:46:11');
...
CREATE TABLE `stok_bahan` (
  ...
  `satuan_bahan` varchar(30) DEFAULT 'Pcs'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `stok_bahan` (`id_stok`, `id_tenant`, `nama_bahan`, `jumlah_stok`, `satuan_bahan`) VALUES
...
(6, 'Tenant Kosong', 'Bapak Kosong', '0800000000');
...
(16, 1, 1, NULL, '2026-06-09 00:32:20', 15000, 'Tunai');
